...
export default class BaseController {
	...
	createPath(params: EndpointParams) {
	    ...
	    const returnCallback = (req, res) => {
	    	...
	    	bodyParams = this.getArgs(params.bodyParams, params.bodyParams, req.body),
	    	queryParams = this.getArgs(params.queryParams, this.queryParams, req.query),
	    	urlParams = this.getArgs(params.urlParams, this.urlParams, req.params);
