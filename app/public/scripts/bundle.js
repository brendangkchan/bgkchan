...
/***/ function(module, exports, __webpack_require__) {
	...
	var routes = __webpack_require__(242).routes;
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement(
									Link,
									{ to: '/', activeStyle: { fontWeight: 'bold' }, onlyActiveOnIndex: true },
									'Comments'
								)
							),
							React.createElement(
					...
					React.createElement('script', { src: 'scripts/polyfill.js' }),
					React.createElement('script', { src: 'https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.0/jquery.min.js' }),
					React.createElement('script', { src: 'scripts/bundle.js' })
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ReactRedux = __webpack_require__(159);
	...
	var CommentForm = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      'form',
	      { className: 'commentForm', method: 'post', action: this.props.url, onSubmit: this.handleSubmit },
	...
	var CommentBoxState = function CommentBoxState(state) {
	  return {
	    data: state.data,
	    url: state.url,
	...
	var CommentBoxDispatch = function CommentBoxDispatch(dispatch) {
	  return {
	...
	var CommentListState = function CommentListState(state) {
	  return {
	    data: state.data
	  };
	};
	
	var CommentFormState = function CommentFormState(state) {
	  return {
	    url: state.url
	  };
	};
	...
	CommentBox = connect(CommentBoxState, CommentBoxDispatch)(CommentBox);
	CommentList = connect(CommentListState)(CommentList);
	CommentForm = connect(CommentFormState)(CommentForm);
